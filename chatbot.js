...
$(document).ready(function () {
    ...
    $options.on('click', function() {
  	  if(messenger.isOpen) {
  		  console.log('close: ');
  		  $options.css("background-image", "url(https://brainshop.ai/web/img/chat_white.png)");
          ...
          sendMessage('clickDown');
  		  ...
  		  console.log('open: ');
  		   $options.css("background-image", "url(https://brainshop.ai/web/img/ic_arrow_down_white_48dp.png)");
